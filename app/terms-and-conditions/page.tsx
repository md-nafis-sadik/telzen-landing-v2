...
export const metadata: Metadata = {
  ...
  description:
    "Review Telzen's terms and conditions for using our eSIM services. Understand your rights and obligations when using our platform.",
  keywords:
    "terms and conditions, service agreement, user agreement, Telzen terms, eSIM terms, legal terms",
  openGraph: {
    title: "Terms and Conditions - Service Agreement | Telzen",
    description:
      "Review Telzen's terms and conditions for using our eSIM services. Understand your rights and obligations when using our platform.",
          ...
          <div className="flex flex-col gap-4 md:gap-5 lg:gap-6 text-sm md:text-base lg:text-lg leading-[160%] text-[#888]">
            ...
            {sections.map((section: any, sectionIndex: number) => (
              <div key={sectionIndex}>
                <ol
                  className="list-decimal list-inside font-bold"
